...
public class CsvGroceriesDAOImplTest {
    private static final String CSV_FILE = "test_grocery.csv";
    ...
    void setup() throws IOException {
        ...
        OBJECT_MAPPER.writeValue(new File(CSV_FILE), new HashMap<String, Map<String, Integer>>());
    }
